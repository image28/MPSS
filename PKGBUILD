...
source=(
  ...
  mpss-micmgmt-a2x-nonverbose.patch
  ...
  mpss-modules-userpages-include.patch
  mpss-myo-generateManPages-8859-1.patch
)
sha256sums=('fa90245eb48ed01ba6a974395cd706d0b023f13d71da5cc29158bf615731b269'
            '48a26566b7017383abe7cb2618d861eeb14def80087ccd5da8995065d675b9f4'
            'af4c49f3a220ad26e6d4ab2ac73d3ecdcc3c137cfd9331d55ff4089a49a4c98d'
            ...
            '2b64413a10ac8ec0f67fa71562fb1ba5487c371e66572b291271465b886f2fc2'
            ...
            '04390878d52e19aec861435367a0c925d811f1bd295bcc5d88693983eb3eb9ce'
            'efa0f6808268819ba75143f9f7d65400bd4ecc83ade6e0ff1bf5f7458a05a3c7')
...
prepare() {
  ...
  for p in $srcdir/*.patch; do
    ( cd $srcdir && patch --forward --strip=0 --ignore-whitespace --input="$p" );
  done
}

# common build variables
_metadata_include_dir=$startdir/$pkgbase/src/mpss-metadata
_install_root="$startdir/$pkgbase/pkg/build"
